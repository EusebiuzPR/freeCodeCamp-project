...
You should have a function named getGrade that takes a student score as a parameter and returns a string 
...
that takes a score as a parameter and returns either true or false depending on if the score corresponds to a passing grade.

The hasPassingGrade function should use the getGrade function to get the letter grade, 
and use it to determine if the grade is passing. 
A passing grade is anything different from "F".
...
Replace average-goes-here with the average of total scores and grade-goes-here with the student's grade. Use getAverage to 
get the average score and getGrade to get the student's grade.
...
function studentMsg(arr,score) {
  ...
  let nota = getGrade(score); 
        ...
        if (hasPassingGrade(score)) {
          return `Class average: ${ave}. Your grade: ${nota}. You passed the course.`
        }
        else {
          return `Class average: ${ave}. Your grade: ${nota}. You failed the course.`
        }
